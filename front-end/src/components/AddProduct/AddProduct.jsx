...
import { getCategoryProduct,getSingleProduct } from "./../Redux/product/action";
...
function AddProduct(props) {
  ...
  const dataArr = useSelector((state) => state.product.categoryData);
  ...
  useEffect(() => {
    if (params.categories) {
      dispatch(getCategoryProduct(params.categories));
  ...
  }, [dispatch, params.categories,params.id,params.category,props.id]);
