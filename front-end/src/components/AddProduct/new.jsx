...
function AddProduct(props) {
    ...
    const dataArr = useSelector((state) => state.product.singleProData);
    ...
    const handleAddClick = () => {
        ...
        // let dataArr = dataArr.find((item) => prodId === item._id);
        console.log(dataArr)
        let reqProd = {
            id: dataArr._id,
            title: dataArr.product.title,
            imageLink: dataArr.product.image,
            category: dataArr.category,
            sub_ctg: dataArr.sub_category,
            price: dataArr.product.price,
            inCartQty: 0,
            presentInCart: false,
        };
        console.log(reqProd)
