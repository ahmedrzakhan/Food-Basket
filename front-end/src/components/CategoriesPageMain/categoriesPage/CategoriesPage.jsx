  ...
  return (
    <>
      ...
      <div style={{ clear: "both" }}></div>
          ...
          <Grid container>
            <div style={{clear: "both"}}></div>
            <Grid  item sm={12} md={12} lg={2} style={{border: "1px solid rgb(232, 232, 232)"}}>
                <Grid item style={{borderBottom: "1px solid rgb(232, 232, 232)",padding:"10px 0px" , height: "250px", overflowY: "scroll"}}  item sm={4} md={5} lg={12}>
                ...
                <Grid item style={{borderBottom: "1px solid rgb(232, 232, 232)",padding:"10px 0px" , height: "250px", overflowY: "scroll"}}  item sm={4} md={5} lg={12}>
                  ...
                  <ul className={styles.checkBoxesList}>
                    {checkBoxInputsArr.map((item) => {
                      return (
                        <li style={{ fontSize: "15px", marginBottom:"15px" }}>
                          <input
                            id={item}
                            type="checkbox"
                            name={item}
            ...
            <Grid item style={{paddingLeft: "10px", marginBottom: "20px"}} item sm={12} md={12} lg={10}>
              ...
              <div >
                <h2 style={{borderBottom: "1px solid rgb(232, 232, 232)"}}>Fruits and Vegetables</h2>
              </div>
