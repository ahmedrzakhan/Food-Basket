...
const singleProductSample = {
    name: "Apple Royal Gala - New Zealand", imageLink: "https://d1z88p83zuviay.cloudfront.net/ProductVariantThumbnailImages/b05894c9-bafd-45af-95bf-30fe304d242c_425x425.jpg", qty: "1kg", price: 280, description: `Harvested from mid February to late March, 
        ...
        <>
            ...
            <Box className={classes.marginLeftSide}>
                <Breadcrumbs separator="›" aria-label="breadcrumb">
                    ...
                    <Link color="inherit" to={`/home/${data.category}/${data.sub_category}`} >
                        {data.category}
                    </Link>
                ...
                <Grid container>
                    ...
                    <Grid item lg={7} md={7} sm={12} xs={12}>
                        ...
                        <Box className={classes.borderBottomOnly}>
                            <small className={styles.inclusive} >  {`(Inclusive of all taxes)`} </small>
                        </Box>
