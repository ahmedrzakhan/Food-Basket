...
function Address() {
    ...
    //   console.log(Object.keys(localStorage))
      ...
      {
            if( (( localStorage.getItem( localStorage.key( i ) ) ) ) === "true" ||  localStorage.getItem( localStorage.key( i ) ) === "false" || Object.keys(localStorage)[i] === "user")  
          { 
            continue
          }
          else
            ...
            <Box>
                ...
                <Box>
                    <Box classes={{ root: styles.box }}>
                       First Name*</Box>
                    <Box> <TextField name="first_name" onChange={ handleChange} variant="outlined" /></Box>
                </Box>
                <Box>
                    <Box classes={{ root: styles.box }}>
                        Last Name*</Box>
                    <Box> <TextField name="last_name" onChange={ handleChange} variant="outlined" /></Box>
                </Box>

                <Box>
                    <Box classes ={{root:styles.box}}>
                        Address*</Box>
                    <Box> <TextField name="address" onChange={ handleChange} variant="outlined" /></Box>
                </Box>
                <Box>
                    <Box classes={{ root: styles.box }}>
                        Landmark*</Box>
                    <Box> <TextField name="landmark" onChange={ handleChange} variant="outlined" /></Box>
                </Box>
                <Box>
                    <Box classes={{ root: styles.box }}>
                        Pincode*</Box>
                    <Box> <TextField name="pincode" onChange={ handleChange} variant="outlined" /></Box>
                </Box>
                <Box>
                    <Box classes={{ root: styles.box }}>
                        Country*</Box>
                    <Box> <TextField name="country" onChange={ handleChange} variant="outlined" /></Box>
                </Box>
                <Box>
                    <Box classes={{ root: styles.box }}>
                        State*</Box>
                    <Box> <TextField name="state" onChange={ handleChange} variant="outlined" /></Box>
                </Box>
                <Box>
                    <Box classes={{ root: styles.box }}>
                        City*</Box>
                    <Box> <TextField name="city" onChange={ handleChange} variant="outlined" /></Box>
                </Box>
                <Box>
                    <Box classes={{ root: styles.box }}>
                        Mobile No*</Box>
                    <Box> <TextField name="mobile_no" onChange={ handleChange} variant="outlined" /></Box>
                </Box>
                <Box>
