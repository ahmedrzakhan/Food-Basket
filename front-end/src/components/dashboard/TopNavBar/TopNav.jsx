                ...
                {login ?
                    <Box classes={{ root: styles.login }}>
                        <Box classes={{ root: styles.inputBox }}>
                            ...
                            <Button classes={{ root: styles.close }} onClick={() => setLogin(false)}> <img src="https://d1z88p83zuviay.cloudfront.net/Images/login-popup-close.png" alt="close"></img>
                            </Button>
                        </Box>
                ...
                <Box >
                    ...
                    <Box>
                        <Box className={classes.login} m={1} >
                            ...
                            <Link className={styles.Toplink} to="/"> Fresh & Fast</Link>
                            <button onClick={() => setLogin(true)} className={styles.topRight} >Register</button>
                            <button onClick={() => setRegister(true)} className={styles.topRight}>Login</button>
                        ...
                        <Box>
                            ...
                            <Box className={classes.newBox}>
                                <Box>
                                    ...
                                    <ShoppingCartOutlinedIcon classes={{ root: styles.starCart }} />
